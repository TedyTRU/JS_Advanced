...
//     const getSection = n =>
//         console.log(document.querySelector(`body > main > div > section:nth-child(${n}) > div:nth-child(2)`));
...
//             const [t, d, date] = [html.task.ariaValueMin, html.description.ariaValueMin, html.date.value];
//             const actions = {

class ChristmasDinner {
    ...
    recipes({ recipeName, productsList }) {
        ...
        if (!productsList.every(pr => this.products.includes(pr))) {
    ...
    showAttendance() {
        ...
        Object.entries(this.guests).forEach(([key, value]) =>
            result.push(`${key} will eat ${value}, which consists of ${this.dishes.find(d => d.recipeName == value).productsList.join(', ')}`));
...
let dinner = new ChristmasDinner(10);
